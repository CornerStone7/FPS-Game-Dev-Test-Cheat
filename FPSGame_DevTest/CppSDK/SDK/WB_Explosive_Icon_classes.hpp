...
// WidgetBlueprintGeneratedClass WB_Explosive_Icon.WB_Explosive_Icon_C
// 0x0020 (0x0280 - 0x0260)
class UWB_Explosive_Icon_C final : public UUserWidget
{
public:
...
public:
	...
	void ShowWidget();
	void HideWidget();
	void ExecuteUbergraph_WB_Explosive_Icon(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"WB_Explosive_Icon_C">();
	}
	static class UWB_Explosive_Icon_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWB_Explosive_Icon_C>();
	}
};
static_assert(alignof(UWB_Explosive_Icon_C) == 0x000008, "Wrong alignment on UWB_Explosive_Icon_C");
static_assert(sizeof(UWB_Explosive_Icon_C) == 0x000280, "Wrong size on UWB_Explosive_Icon_C");
static_assert(offsetof(UWB_Explosive_Icon_C, UberGraphFrame) == 0x000260, "Member 'UWB_Explosive_Icon_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWB_Explosive_Icon_C, OnStart_Icon_Anim) == 0x000268, "Member 'UWB_Explosive_Icon_C::OnStart_Icon_Anim' has a wrong offset!");
static_assert(offsetof(UWB_Explosive_Icon_C, Icon) == 0x000270, "Member 'UWB_Explosive_Icon_C::Icon' has a wrong offset!");
static_assert(offsetof(UWB_Explosive_Icon_C, HideWidgetTimer) == 0x000278, "Member 'UWB_Explosive_Icon_C::HideWidgetTimer' has a wrong offset!");
