...
// BlueprintGeneratedClass BP_SmallAmmoBox.BP_SmallAmmoBox_C
// 0x0038 (0x0258 - 0x0220)
class ABP_SmallAmmoBox_C final : public AActor
{
public:
...
public:
	...
	void ExecuteUbergraph_BP_SmallAmmoBox(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_SmallAmmoBox_C">();
	}
	static class ABP_SmallAmmoBox_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_SmallAmmoBox_C>();
	}
};
static_assert(alignof(ABP_SmallAmmoBox_C) == 0x000008, "Wrong alignment on ABP_SmallAmmoBox_C");
static_assert(sizeof(ABP_SmallAmmoBox_C) == 0x000258, "Wrong size on ABP_SmallAmmoBox_C");
static_assert(offsetof(ABP_SmallAmmoBox_C, UberGraphFrame) == 0x000220, "Member 'ABP_SmallAmmoBox_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_SmallAmmoBox_C, Scene) == 0x000228, "Member 'ABP_SmallAmmoBox_C::Scene' has a wrong offset!");
static_assert(offsetof(ABP_SmallAmmoBox_C, StaticMesh) == 0x000230, "Member 'ABP_SmallAmmoBox_C::StaticMesh' has a wrong offset!");
static_assert(offsetof(ABP_SmallAmmoBox_C, WidgetActor) == 0x000238, "Member 'ABP_SmallAmmoBox_C::WidgetActor' has a wrong offset!");
static_assert(offsetof(ABP_SmallAmmoBox_C, InfluenceSphere) == 0x000240, "Member 'ABP_SmallAmmoBox_C::InfluenceSphere' has a wrong offset!");
static_assert(offsetof(ABP_SmallAmmoBox_C, bActive) == 0x000248, "Member 'ABP_SmallAmmoBox_C::bActive' has a wrong offset!");
static_assert(offsetof(ABP_SmallAmmoBox_C, CheckVelocityTimerHandle) == 0x000250, "Member 'ABP_SmallAmmoBox_C::CheckVelocityTimerHandle' has a wrong offset!");
