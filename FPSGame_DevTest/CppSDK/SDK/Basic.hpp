...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04A38A50;
	constexpr int32 AppendString      = 0x01038B40;
	constexpr int32 GNames            = 0x049FC700;
	constexpr int32 GWorld            = 0x04B80F70;
	constexpr int32 ProcessEvent      = 0x012291F0;
